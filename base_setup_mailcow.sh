...
sed -i '1i*nat \ :POSTROUTING ACCEPT [0:0] \ -A POSTROUTING ! -o docker0 -s 172.22.1.0/24 -j MASQUERADE \ COMMIT' /etc/ufw/after.rules

sed -i '1i*nat \ :POSTROUTING ACCEPT [0:0] \ -A POSTROUTING ! -o docker0 -s fd4d:6169:6c63:6f77::/64 -j MASQUERADE \ COMMIT' /etc/ufw/after6.rules
